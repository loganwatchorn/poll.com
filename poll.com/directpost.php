...
$a5 = '';
$d = '';//datetime("Y-m-d h:m:s");//date added(datetime)
$ab = $_SESSION['username'];//added by
$pt = $username;//user posted to

if ($submit) {
  if ($q&&$a1&&$a2) {
    if (strlen($q)<200) {
      if (strlen($a1)<100||strlen($a2)<100||strlen($a3)<100||strlen($a4)<100||strlen($a5)<100) {
$queryreg = mysql_query("INSERT INTO posts VALUES ('','$q','$a1','$a2','$a3','$a4','$a5','','$ab','$username')");
